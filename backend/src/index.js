...
app.use('/api/jugadores', require('./routes/jugadores.routes').router);
...
app.get('/health', (req, res) => {
  res.json({ status: 'ok', project: 'GoVenue API v2', env: process.env.NODE_ENV });
});
...
app.listen(PORT, () => console.log(`🚀 GoVenue API v2 corriendo en puerto ${PORT}`));
